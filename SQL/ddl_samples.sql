...
select o.OrderID as [Sipariþ No],
c.CompanyName as [Müþteri Adi],
o.ShipAddress + ' ' + o.ShipCity + ' / ' + o.ShipCountry as [Teslimat Adresi],
s.CompanyName as [Kargo Firmasý],
SUM(od.Quantity * od.UnitPrice) as Toplam,
o.Freight as [Kargo Ücreti],
SUM(od.Quantity * od.UnitPrice) + o.Freight as [Genel Sipariþ Toplamý]
